...
glossary <- tribble( 
  ~term, ~definition,                  
    ...
    "**cumulative distribution function (CDF)**","A function that maps from values to their cumulative probabilities. $\mathrm{CDF}(x)$ is the fraction of the sample less than or equal to $x$",
    ...
    "**complementary CDF**","A function that maps from a value, $x$, to the fraction of values that exceed $x$, which is $1 - \mathrm{CDF}(x)$",
    ...
    "**odds**","An alternative way of representing a probability, P, as the ratio of the probability and its complement, P / (1-P).",           "**time series**","A dataset where each value is associated with a timestamp, often a series of measurements and the times they were collected",
    ...
    "**span**","A parameter of EWMA (exponentially-weighted moving average) that determines how quickly the weights decrease",
